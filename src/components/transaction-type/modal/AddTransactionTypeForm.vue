...
async function submitHandler(data) {
  await transactionTypeStore.add(data);
}
</script>
...
<template>
  <div class="
      ...
      left-0
    " id="modal">
    <Success v-if="successAlert" @close="successAlert = !successAlert" message="Transaction type added!" />
    <div class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
      <div class="
        ...
        <FormKit type="form" @submit="submitHandler">
          <FormKit type="text" name="name" help="Masukkan jenis transaksi" validation="required">
          </FormKit>
        </FormKit>
        <div class="
            cursor-pointer
